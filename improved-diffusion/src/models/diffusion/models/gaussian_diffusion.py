...
from src.models.diffusion.modules.nn import mean_flat
from src.models.diffusion.modules.losses import (
    normal_kl, 
...
class GaussianDiffusion:
    ...
    def training_losses(self, model, *args, **kwargs):
        if self.training_mode == 'e2e':
            print("\n WHAT MODEL TYPE DO I HAVE? ", type(model))
    ...
    def p_mean_variance(
        self, model, x, t, clip_denoised=True, denoised_fn=None, condition_eeg=None, model_kwargs=None
    ):
        """
        Apply the model to get p(x_{t-1} | x_t), as well as a prediction of
        the initial x, x_0.
